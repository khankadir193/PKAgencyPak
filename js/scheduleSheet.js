...
const getDataFromGoogleSheets2 = (SHEET_ID,RANGE,SHEET_TITLE,tableNo) => {
    ...
    fetch(GOOGLE_SHEET_URL)
      ...
      .then((data) => {
        ...
        if (jsonStart !== -1) {
          ...
          const tableBody = document.getElementById("pakistanTableBody"+tableNo);
          let timeFlag = true;
          ...
          const tableContainer = document.getElementById("pakTable"+tableNo);
  ...
  getDataFromGoogleSheets2("11ZLpOSrhZISYYzGusflZZA3FcXkznRKfvaO_t9hzKJA","B242:E244","Dec 23 Agency PK Battle","1");
  getDataFromGoogleSheets2("11ZLpOSrhZISYYzGusflZZA3FcXkznRKfvaO_t9hzKJA","B246:E248","Dec 23 Agency PK Battle","2");
  getDataFromGoogleSheets2("11ZLpOSrhZISYYzGusflZZA3FcXkznRKfvaO_t9hzKJA","B250:E252","Dec 23 Agency PK Battle","3");
  // getDataFromGoogleSheets2("11ZLpOSrhZISYYzGusflZZA3FcXkznRKfvaO_t9hzKJA","B203:E205","Dec 23 Agency PK Battle","4");
  // getDataFromGoogleSheets2("11ZLpOSrhZISYYzGusflZZA3FcXkznRKfvaO_t9hzKJA","B207:E209","Dec 23 Agency PK Battle","5");